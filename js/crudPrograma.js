...
function addEstado() {
    ...
    if (esValido) {
        $.ajax({
            url: '../pages/Actions/actionAddPrograma.php',
            type: 'POST',
            data: {
                nombre: estado,
            ...
            success: function (resultado) {
                //alert(resultado);
                alert("Se agrego el programa academico");
...
function delEstado() {
    ...
    $.ajax({
        url: '../pages/Actions/actionDelPrograma.php',
        type: 'POST',
        data: {
            id: idEliminar,
            accion: 'eliminar'
        ...
        success: function (Resultado) {
            //alert(Resultado);
            alert("Se elimino el programa academico");
            var resJSON = JSON.parse(Resultado);
            if (resJSON.estado == 1) {
...
function updateEstado() {
    ...
    if (esValido) {
        $.ajax({
            url: '../pages/Actions/actionUpdatePrograma.php',
            type: 'POST',
            data: {
                nombre: updateEstado,
            ...
            success: function (resultado) {
                ...
                //alert(resJSON.mensaje);
                //alert(resultado);
                alert("Se actualizo el programa academico");
            },
            error: function () {
