...
function addEstado() {
    ...
    if (esValido) {
        $.ajax({
            url: '../pages/Actions/actionAddPractica.php',
            type: 'POST',
            data: {
                nombre: estado,
            ...
            success: function (resultado) {
                //alert(resultado);
                alert("Se agrego el tipo de practica");
...
function delEstado() {
    ...
    $.ajax({
        url: '../pages/Actions/actionDelPractica.php',
        type: 'POST',
        data: {
            id: idEliminar,
            accion: 'eliminar'
        ...
        success: function (Resultado) {
            //alert(Resultado);
            alert("Se elimino el tipo de practica");
            var resJSON = JSON.parse(Resultado);
            if (resJSON.estado == 1) {
...
function updateEstado() {
    ...
    if (esValido) {
        $.ajax({
            url: '../pages/Actions/actionUpdatePractica.php',
            type: 'POST',
            data: {
                nombre: updateEstado,
            ...
            success: function (resultado) {
                ...
                //alert(resJSON.mensaje);
                //alert(resultado);
                alert("Se actualizo el tipo de practica");
            },
            error: function () {
