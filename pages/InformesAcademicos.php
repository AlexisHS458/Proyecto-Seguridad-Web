...
<?php
  ...
  if(mysqli_connect_errno()){
    ...
    $consulta_id="SELECT A.id, A.fecha, A.institucion, A.profesor_id, P.id, P.nombre FROM practicas A INNER JOIN profesor P ON A.profesor_id=P.id";  
    $resultado_consulta_id=mysqli_query($Con,$consulta_id);
...
<head>
    ...
    <title>Captura Informes Académicos</title>
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Captura de Informes Académicos</h3>
                        ...
                        while ($renglonEstado=mysqli_fetch_array($resultado_consulta_id)) {

                            
                            echo "<tr id='row_".$renglonEstado['id']."'>";
                            echo "<td>".$renglonEstado[0]."</td>";
                            echo "<td>".$renglonEstado['institucion']."</td>";
                            echo "<td>".$renglonEstado['fecha']."</td>";
                            echo "<td>".$renglonEstado['nombre']."</td>";
                            
                              
                      echo '<td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modaledit" onclick="identificaActualizar('.$renglonEstado[0].');">
                        Actualizar
                        </button> </td>';
                      echo "</tr>";
    ...
    <div class="modal fade" id="modaledit">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label>¿Considera usted, que se cumplió el objetivo deseado?</label><br>
                                    <input type="text" class="form-control" id="objetivoEdit" name="Presupuesto" style="width: 515px;">



                                    <br></br>
                                    <label>¿Por qué?</label>
                                    <textarea name="com" rows="3" cols="70" id="porqueEdit" placeholder="Escriba aquí"></textarea>

                                    <br></br>

                                    <label>Describa brevemente, la actividad académica desarrollada y el o los beneficios que se obtuvieron. </label>
                                    <textarea name="est" rows="3" cols="70" id="descripcionEdit" placeholder="Escriba aquí"></textarea>
                                    <br></br>


                                    <label>Conclusiones: </label>
                                    <textarea name="est" rows="3" cols="70" id="conclusionesEdit" placeholder="Escriba aquí"></textarea>
                                    <br></br>

                                    <label>Observaciones </label>
                                    <textarea name="est" rows="3" cols="70"  id="observacionesEdit" placeholder="Escriba aquí"></textarea>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn  pull-left btn-success" onclick="updateEstado();">Guardar</button>
        ...
        <script src="../js/crudInformes.js"></script>
</body>
