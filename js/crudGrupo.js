...
function addEstado() {
    ...
    //alert("Hola");
    $.ajax({
        url: '../pages/Actions/actionAddGrupo.php',
        type: 'POST',
        data: {
            nombre: estado,
...
function delEstado() {
    ...
    $.ajax({
        url: '../pages/Actions/actionDelGrupo.php',
        type: 'POST',
        data: {
            id: idEliminar,
            accion: 'eliminar'
...
function updateEstado() {
    ...
    //$=Libreria de JQERY
    $.ajax({
        url: '../pages/Actions/actionUpdateGrupo.php',
        type: 'POST',
        data: {
            nombre: updateEstado,
