...
<?php
  ...
  if(mysqli_connect_errno()){
    ...
    $Query_estado="SELECT * FROM unidad_aprendizaje";
...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="InformesAcademicos.php">
                            <i class="fa fa-edit"></i> <span>Captura informes <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;académicoa</span>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Unidad de Aprendizaje</h3>
                                <div class="pull-right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Editar Unidad de Aprendizaje</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Nombre de la Unidad de Aprendizaje</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Agregar Unidad de Aprendizaje</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Nombre de la Unidad de Aprendizaje</label>
    ...
    <script src="../js/crudUAP.js"></script>
</body>
