...
<?php
  ...
  if(mysqli_connect_errno()){
    ...
    $Query_estado="SELECT * FROM profesor";
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Alta Profesor</h3>
                                <div class="pull-right">
                                    <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-add" id="buttonAddestado">
                                        Agregar
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Nombre del profesor</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="updateEstado();">Actualizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <script src="../js/crudProfesor.js"></script>
</body>
