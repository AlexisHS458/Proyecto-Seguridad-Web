...
function addEstado() {
    ...
    //alert("Hola");
    $.ajax({
        url: '../pages/Actions/actionAddNivel.php',
        type: 'POST',
        data: {
            nombre: estado,
...
function delEstado() {
    ...
    $.ajax({
        url: '../pages/Actions/actionDelNivel.php',
        type: 'POST',
        data: {
            id: idEliminar,
            accion: 'eliminar'
...
function updateEstado() {
    ...
    //$=Libreria de JQERY
    $.ajax({
        url: '../pages/Actions/actionUpdateNivel.php',
        type: 'POST',
        data: {
            nombre: updateEstado,
