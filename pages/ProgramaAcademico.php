...
<?php
 $bandRegitros=0;
  ...
  if(mysqli_connect_errno()){
    ...
    $Query_estado="SELECT * FROM programa_academico";
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Alta Programa academico</h3>
                                <div class="pull-right">
                                    <button type="button" id="buttonAddestado" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-add">
                                        Agregar
                                    </button>
                                </div>
                ...
                <?php
                  if($bandRegitros==1){
                    ...
                    while ($renglonEstado=mysqli_fetch_array($Resultado_estado)) {
                      ...
                      echo "<td>".$renglonEstado['id']."</td>";
                      echo "<td>".$renglonEstado['nombre']."</td>";
                      echo "<td>".$renglonEstado['descripcion']."</td>";
                      echo '<td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-edit" onclick="identificaActualizar('.$renglonEstado['id'].');">
                        Actualizar
                        </button> </td>';
                      echo '<td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete" onclick="identificaEliminar('.$renglonEstado['id'].');">
                        Eliminar
                        </button> </td> ';
                      echo "</tr>";
                    }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Eliminar plantel</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline" data-toggle="modal" data-target="#modal-delete" onclick="delEstado();">Eliminar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Editar Plantel/Centro</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Nombre del Plantel</label>
                        <input type="email" class="form-control" id="estadoActualizar" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Clave SEP</label>
                        <input type="email" class="form-control" id="descripcionActualizar" >
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" onclick="updateEstado();" >Agregar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" onclick="addEstado();">
                        Agregar
                    </button>
                </div>
            </div>
    ...
    <script src="../js/crudPrograma.js"></script>
</body>
