...
<head>
    ...
    <title>Entidad Federativa</title>
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Entidad Federativa</h3>
                                <div class="pull-right">
                                    <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-add">
                                        Agregar
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Editar Entidad Federativa</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Nombre de la Entidad Federativa</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="buttonAddestado">Agregar Entidad Federativa</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Nombre de la Entidad Federativa</label>
    ...
    <script src="../js/crudEstado.js"></script>
</body>
