...
<?php
  ...
  if(mysqli_connect_errno()){
    ...
    $Query_estado="SELECT * FROM nivel";
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Alta de niveles</h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Nivel</label>
                        <input type="email" class="form-control" id="estadoActualizar">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Descripción</label>
                        <input type="email" class="form-control" id="descripcionActualizar" id="descripcion">
                    </div>
                </div>
    ...
    <script src="../js/crudNivel.js"></script>
</body>
