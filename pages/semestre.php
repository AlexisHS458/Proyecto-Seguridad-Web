...
<?php
  ...
  if(mysqli_connect_errno()){
    ...
    $Query_estado="SELECT * FROM semestre";
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Alta de semestres</h3>
                                <div class="pull-right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Semestre</label>
                        <input type="email" id="estadoActualizar" class="form-control" id="UAP">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Descripción</label>
                        <input type="email" id="descripcionActualizar" class="form-control" id="descripcion">
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="NombrePractica">Semestre</label>
                        <input type="email"  id="estado" class="form-control" id="UAP">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Descripción</label>
                        <input type="email" id="descripcion" class="form-control" id="descripcion">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cerrar</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Eliminar semestre</h4>
                </div>
                <div class="modal-body">
                    <p>¿Deseas eliminar?</p>
                </div>
    ...
    <script src="../js/crudSemestre.js"></script>
</body>
